...
const __VLS_51 = {
    onClick: (...[$event]) => {
        __VLS_ctx.shareVisible = true;
    }
};
__VLS_47.slots.default;
var __VLS_47;
/** @type {[typeof ShareDialog, ]} */ ;
// @ts-ignore
const __VLS_52 = __VLS_asFunctionalComponent(ShareDialog, new ShareDialog({
    modelValue: (__VLS_ctx.shareVisible),
    rois: (__VLS_ctx.rois),
    preset: (__VLS_ctx.store.preset),
    windowVal: (__VLS_ctx.store.windowVal),
    levelVal: (__VLS_ctx.store.levelVal),
}));
